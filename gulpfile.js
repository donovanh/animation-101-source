...
gulp.task('tip-images', function () {
  return gulp.src('src/tips/**')
    .pipe($.changed('site/tips'))
    .pipe($.imagemin({
      // Lossless conversion to progressive JPGs
      progressive: true,
      // Interlace GIFs for progressive rendering
...
gulp.task('copy-js', function () {
  return gulp.src(['serve/assets/javascript/**/*'])
...
gulp.task('deploy', function () {
  ...
  return gulp.src('./site/**/*')
    .pipe($.ghPages({
      ...
      remoteUrl: 'git@github.com:cssanimation/cssanimation.github.io.git',
      branch: 'master'
    }));
});
